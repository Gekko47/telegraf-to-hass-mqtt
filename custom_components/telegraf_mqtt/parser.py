...
class TelegrafParser:
    ...
    _PARSERS: ClassVar[dict[str, PayloadParser]] = {
        ...
        "diskio": parse_diskio_payload,
        # Docker splits into several measurements on the wire; the
        # dispatch table needs every one to keep them out of the
        # unknown-fallback path.
        "docker_container_cpu": parse_docker_container_cpu_payload,
        "docker_container_mem": parse_docker_container_mem_payload,
        "docker_container_net": parse_docker_container_net_payload,
        "docker_container_blkio": parse_docker_container_blkio_payload,
        "docker_container_status": parse_docker_container_status_payload,
        "docker": parse_docker_payload,
        "http_response": parse_http_response_payload,
        "interrupts": parse_interrupts_payload,
        "ipmi_sensor": parse_ipmi_sensor_payload,
        "kernel": parse_kernel_payload,
        "kernel_vmstat": parse_kernel_vmstat_payload,
        "mem": parse_mem_payload,
        "net": parse_net_payload,
        "net_response": parse_net_response_payload,
        "nvidia_gpu": parse_nvidia_gpu_payload,
        "ping": parse_ping_payload,
        "processes": parse_processes_payload,
        "sensors": parse_sensors_payload,
        "smart": parse_smart_payload,
        "soft_interrupts": parse_interrupts_payload,
        "swap": parse_swap_payload,
        "system": parse_system_payload,
        "wireless": parse_wireless_payload,
        # ZFS splits into three measurements too.
        "zfs": parse_zfs_payload,
        "zfs_pool": parse_zfs_pool_payload,
        "zfs_dataset": parse_zfs_dataset_payload,
    }
